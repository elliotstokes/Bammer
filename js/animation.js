	...
	*/
	...
	function changeKey(which, to) {
		switch (which) {
			case 65:
			case 37:
				_GameState.KeysPressed[0] = to;
				break; // left
			case 38:
				_GameState.KeysPressed[2] = to;
				break; // up
			case 39:
				_GameState.KeysPressed[1] = to;
				break; // right
			case 40:
				_GameState.KeysPressed[3] = to;
				break; // down
			case 32:
				_GameState.KeysPressed[4] = to;
				break; // space bar;
			case 90:
				_GameState.KeysPressed[5] = to;
				break; //z key
			case 88:
				_GameState.KeysPressed[6] = to;
				break; //x key
			case 83:
				_GameState.KeysPressed[7] = to;
				break; //s key
		}
	...
	window.onload = function() {
		var items = [{
				identifier: "enemyImage",
				type: "image",
				src: "images/house.jpeg"
			}, {
				identifier: "backgroudSound",
				type: "audio",
				...
				identifier: "explosionSound",
				type: "audio",
				src: "sounds/explosion.mp3"
			}, {
				identifier: "laserSound",
				type: "audio",
	...
	function startGame(success) {
		...
		if (_CanvasElement && _CanvasElement.getContext) {
			...
			if (_Context) {
				...
				_GameState.CanvasHeight = 500;
				_GameState.CanvasWidth = 800;
				_Ship = new Ship(_Context, _GameState.CanvasWidth, _GameState.CanvasHeight);
				animate();
			}
		}
	}
